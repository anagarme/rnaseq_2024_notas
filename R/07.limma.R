...
## Paquete limma
## Sirve para realizar el análisis de expresión diferencial.
## Voom toma datos de RNA-seq, en count no hay
## valores negativos porque el mínimo es 0.
## limma hace muy bien las regresiones lineales
library("limma")
vGene <- voom(dge, mod, plot = TRUE)

eb_results <- eBayes(lmFit(vGene)) # microarreglos
## eBayes es la que permite calcular los valores p, empirical Bayes
## es la que toma en cuenta los estimados de la varianza.
...
##
## Revisión
## Esimportante para especificar qué coeficiente se utilizará para clasificar los genes
